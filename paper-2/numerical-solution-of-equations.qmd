...
(a) By sketching the graphs of $y=|5-2x|$ and $y=3\ln x$ on the same diagram, show that the equation has exactly two roots. **[3]**
...
(a) The logarithm requires $x>0$. The graph of $y=|5-2x|$ is V-shaped, with vertex $(2.5,0)$; $y=3\ln x$ is increasing and concave down. The two branches of the V give one intersection for $0<x<2.5$ and one for $x>2.5$, so there are exactly two roots.
...
<div class="source-line"><strong>Source:</strong> `PastPaper/2022/2022/9709_s22_qp_21.pdf`, Q5(a–d), and matching mark scheme.</div>
:::
...
(a) Find an expression for $\dfrac{dy}{dx}$. **[2]**
...
$$
\frac{dy}{dx}
=\frac{\dfrac{2(x+3)}{2x+1}-\ln(2x+1)}{(x+3)^2}
=\boxed{\frac{\dfrac{2(x+3)}{2x+1}-\ln(2x+1)}{(x+3)^2}}.
$$
...
<div class="source-line"><strong>Source:</strong> `PastPaper/2024/2024/qp-202406-mathematics-p22.pdf`, Q6(a–d), and matching mark scheme.</div>
:::
