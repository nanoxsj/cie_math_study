...
(b) The radius (CB) has gradient (6/8=3/4). The tangent gradient is (-4/3), so
...
(b) The radius (CP) has vector ((-3,4)), so its gradient is (-4/3). The tangent gradient is (3/4). Through (P=(1,2)),
...
The gradient of (AB) is (8/12=2/3), so the perpendicular gradient is (-3/2). Hence
...
The midpoint (((8+p)/2,(3+q)/2)) lies on (y=-2x+4):
...
<div class="source-line"><strong>Source:</strong> `PastPaper/2022/2022/9709_m22_qp_12.pdf`, Q8(a), and matching `9709_m22_ms_12.pdf`. The diagram is an independently extracted, annotation-cleaned SVG from the original PDF.</div>
:::
...
For (m=-7), the line is (7x+y+9=0). The perpendicular foot from ((3,0)) is (\boxed{(-6/5,-3/5)}).
...
Thus the centre is ((-p/2,-1)).

(b)(i) The tangent (x+2y=10) has gradient (-1/2), so the normal has gradient (2). Through (A=(4,3)),
...
Therefore (-p/2=2), so (p=-4). Substituting (A=(4,3)) into the original equation,
